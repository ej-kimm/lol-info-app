...
export default function ChampionDetail({
  ...
  return (
    <section className="max-w-4xl mx-auto p-8 bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 rounded-2xl shadow-2xl">
      <div>
        ...
        <div className="flex justify-around items-center mb-8">
          ...
          <div className="bg-white bg-opacity-80 p-6 rounded-2xl shadow-lg w-1/2">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">스탯</h3>
